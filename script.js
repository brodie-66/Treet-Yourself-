...
function calculateCost() {
    ...
    let costPerTree;
    if (supplyOption === "all") {
        costPerTree = 6.00; // $3 planting + $3 tree cost (average)
    } else if (supplyOption === "trees") {
        costPerTree = 3.40; // $3 planting + $0.40 additional cost for protectors
    } else if (supplyOption === "protectors") {
        costPerTree = 3.00; // $3 planting only
    } else if (supplyOption === "both") {
        costPerTree = 2.40; // User supplies both trees and protectors
    } else {
